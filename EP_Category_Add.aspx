    ...
    <legend class="legend" style="font-weight: 700; font-size: large;">Category Information</legend> 
      <table  style="border-collapse:collapse;" > 
          <tr>              
              ...
              <td>Category:  <asp:TextBox ID="Text_Category" runat="server"></asp:TextBox></td>             
              
              <td>
                 Input Items:  <asp:TextBox ID="Text_iit" runat="server"></asp:TextBox> 
              </td>
          ...
          <tr>
               <td class="auto-style1">
                  Special Characteristics:  <asp:TextBox ID="Text_sp" runat="server"></asp:TextBox>
              </td>
              
              
               <td class="auto-style1">
                  Methodology:  <asp:TextBox ID="Text_md" runat="server"></asp:TextBox>
              </td>
              


               <td class="auto-style1">
                  Key parameter:  <asp:TextBox ID="Text_kp" runat="server"></asp:TextBox>
              </td>
